...
import { mb, ml, mt, pl, pr, width } from '../../utils/spaces';
import PressableOpacity from '../../components/atoms/PressableOpacity';
import FontStyles from '../../styles/FontStyles';
import Button from '../../components/atoms/Button';
import { fontColor, bR } from '../../utils/spaces';
    ...
    <BackgroundPrimaryColor title={letsgetstarted}>
      ...
      >
        ...
        <View style={[GlobalStyles.viewRow]}>
          ...
          <CustomText title={t("By_continuing")} textStyle={[FontStyles.subText, ml(2)]} />
          <CustomText title={t("terms")} textStyle={[FontStyles.headingText, ml(2)]} underline={true} />
        </View>
