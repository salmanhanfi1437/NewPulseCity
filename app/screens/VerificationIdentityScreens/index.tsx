...
import { fontColor, fS, ml, mt, pl, bR } from '../../utils/spaces';
        ...
        <Card style={[mt(20)]}>
          <View style={[GlobalStyles.viewRow]}>
            ...
            <CustomText
              ...
              textStyle={[GlobalStyles.viewCenter, ml(5), FontStyles.subText]}
            />
          </View>
          ...
          <View style={[GlobalStyles.viewRow, mt(15)]}>
            ...
            <CustomText
              title={rbi_norms}
              textStyle={[GlobalStyles.viewCenter, ml(10), FontStyles.subText]}
            />
          </View>
